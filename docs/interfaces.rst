...
Словарь системы: какие топики существуют, какого они типа, кто их публикует
и в каких единицах выражены величины. Справочник, а не руководство: как
поднять источник топика, написано в :doc:`bringup`, как проверить, что он
живой, - в :doc:`diagnostics`.
...
.. list-table:: Основные топики
   ...
   * - ``/imu/data``
     - ``sensor_msgs/msg/Imu``
     - мост Gazebo или ``imu_bridge`` на роботе
     - EKF/диагностика
