...
Верхнеуровневые модели робота: реальный, гусеничный симуляционный и
дифференциальный. Описывают форму, массы и положение датчиков относительно
корпуса - всё, что попадает в TF ниже ``base_footprint`` и в footprint
костмап.
