...
Датчики в описании робота: где стоят, как повёрнуты и в какой системе
координат отдают данные. Ошибка в ориентации здесь не даёт ни сообщения об
ошибке, ни заметного сбоя - она просто искажает карту.
