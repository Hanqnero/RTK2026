...
- `I_KI_INSIDE` - коэффициент входит в интеграл. Проще настраивать регулятор в реальном времени, но при обнулении KI останется постоянное влияние накопившейся суммы!
