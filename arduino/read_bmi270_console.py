#!/usr/bin/env python3
"""Чтение текстовой консоли отдельной тестовой прошивки BMI270.
...
def parse_args() -> argparse.Namespace:
    """Разобрать параметры порта, timeout и добавления host timestamp."""
...
def main() -> int:
    """Печатать строки firmware до Ctrl+C, заменяя ошибочные UTF-8 байты."""
