...
* TeleopXYZ provides a simple typed teleop prompt for moving in x/y/z coordinates

Installation
------------
* Clone this repository to your local machine
* Run with sudo, i.e. `sudo python3 DemoIK.py`
* For interactive teleop, run `sudo python3 TeleopXYZ.py`

TeleopXYZ commands
------------------
* `x+`, `x-`, `y+`, `y-`, `z+`, `z-` - move one step in the selected axis
* `goto X Y Z` - move to an absolute Cartesian point
* `step N` - change the step size in mm
* `open`, `close` - control the gripper
* `pos`, `help`, `quit` - show position, show commands, or exit
