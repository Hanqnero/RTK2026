...
def _collect_candidate_edges(
    ...
    for start_id, end_id in limiter_edges:
        ...
        # виртуально ориентированное start_id -> end_id с перевёрнутой полилинией.
        #
        # Аннотации при этом не разворачиваются: corridor_hard_side остаётся
        # тем же, хотя при смене направления сторона границы меняется
        # на противоположную.
