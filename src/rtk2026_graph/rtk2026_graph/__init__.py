...
Структура графа — вершины, рёбра, геометрия полилинии, загрузка
из GeoJSON — живёт в ``rtk2026_pose_graph`` и реэкспортируется отсюда.

Прикладные свойства рёбер приходят из ``metadata`` графа, а правила их
трактовки лежат здесь: сторона непересекаемой границы —
...
__all__ = [
    # Реэкспорт из rtk2026_pose_graph.
    "Node",
    "OrientedEdge",
    "RoadGraph",
    "load_geojson_dict",
